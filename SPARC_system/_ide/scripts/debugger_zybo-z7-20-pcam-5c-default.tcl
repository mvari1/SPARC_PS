...
# Usage with xsct: source ./debugger_SPARC-default.tcl
...
set bitfile [file normalize [file join $repo_root SPARC _ide bitstream system_wrapper.bit]]
...
set ps7init [file normalize [file join $repo_root SPARC _ide psinit ps7_init.tcl]]
set elf [file normalize [file join $repo_root SPARC Debug SPARC.elf]]
# 
